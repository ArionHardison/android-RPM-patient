...
import com.telehealthmanager.app.base.CustomLoaderDialog;
...
public class TwilloVideoActivity extends AppCompatActivity {


    private static final int CAMERA_MIC_PERMISSION_REQUEST_CODE = 1;
    private static final String TAG = "VideoActivity";
    CustomLoaderDialog customDialog;
    /*
    ...
    public static boolean USE_TOKEN_SERVER = true;

    String chatPath;
    String id;
    String isVideoCall = "1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twillo_video);
        customDialog = new CustomLoaderDialog(this);
        ...
        id = extras.getString("sender");
        isVideoCall = extras.getString("is_video", "1");
        ...
        //primaryVideoView.setVisibility(isVideoCall == 1 ? View.VISIBLE : View.GONE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_settings:
                startActivity(new Intent(this, TwilloSettingsActivity.class));
                return true;
    ...
    protected void onResume() {
         ...
         */
        audioCodec = getAudioCodecPreference(TwilloSettingsActivity.PREF_AUDIO_CODEC,
                TwilloSettingsActivity.PREF_AUDIO_CODEC_DEFAULT);
        videoCodec = getVideoCodecPreference(TwilloSettingsActivity.PREF_VIDEO_CODEC,
                TwilloSettingsActivity.PREF_VIDEO_CODEC_DEFAULT);
    ...
    private void createAudioAndVideoTracks() {
        ...
        localAudioTrack = LocalAudioTrack.create(getApplicationContext(), true, LOCAL_AUDIO_TRACK_NAME);
    ...
    private void intializeUI() {
        ...
        if (isVideoCall.equalsIgnoreCase("0")) {
            if (localVideoTrack != null) {
    ...
    private VideoCodec getVideoCodecPreference(String key, String defaultValue) {
        ...
        switch (videoCodecName) {
            case Vp8Codec.NAME:
                boolean simulcast = preferences.getBoolean(TwilloSettingsActivity.PREF_VP8_SIMULCAST,
                        TwilloSettingsActivity.PREF_VP8_SIMULCAST_DEFAULT);
    ...
    private EncodingParameters getEncodingParameters() {
        final int maxAudioBitrate = Integer.parseInt(
                preferences.getString(TwilloSettingsActivity.PREF_SENDER_MAX_AUDIO_BITRATE,
                        TwilloSettingsActivity.PREF_SENDER_MAX_AUDIO_BITRATE_DEFAULT));
        final int maxVideoBitrate = Integer.parseInt(
                preferences.getString(TwilloSettingsActivity.PREF_SENDER_MAX_VIDEO_BITRATE,
                        TwilloSettingsActivity.PREF_SENDER_MAX_VIDEO_BITRATE_DEFAULT));
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                ...
                intializeUI();
                Log.e(TAG, "onConnectFailure: " + e.getMessage() + " | " + e.getExplanation() + " | " + e.getLocalizedMessage());
                finish();
            }
            ...
            public void onDisconnected(Room room, TwilioException e) {
                ...
                reconnectingProgressBar.setVisibility(View.GONE);
                TwilloVideoActivity.this.room = null;
    ...
    private View.OnClickListener disconnectClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cancelCallself();
                TwilloVideoActivity.this.intializeUI();
            }
        };
    }
    ...
    private View.OnClickListener connectActionClickListener() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TwilloVideoActivity.this.showConnectDialog();
            }
        };
    }
            ...
            public void onClick(View v) {
                ...
                if (localVideoTrack != null) {
                    ...
                    localVideoActionFab.setImageDrawable(
                            ContextCompat.getDrawable(TwilloVideoActivity.this, icon));
                }
            }
        };
    }
...
//        String accessToken = SharedHelper.getKey(this, "access_token");
        Call<AccessToken> call = appRepository.createApiClient(BuildConfig.BASE_URL, ApiInterface.class).getTwilloVideoToken(chatPath);
        call.enqueue(new Callback<AccessToken>() {
            @Override
            public void onResponse(@NonNull Call<AccessToken> call, @NonNull retrofit2.Response<AccessToken> response) {
                customDialog.dismiss();
                if (response.isSuccessful()) {
                    TwilloVideoActivity.this.accessToken = response.body().getAccessToken();
                   // TwilloVideoActivity.this.accessToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..jI1mCwN3WvkIX2sF-yuWAnbLqZq15ogZJAoG5U4jJ8s";
                    ...
                    Log.d(TAG, "token: " + TwilloVideoActivity.this.accessToken);
                    connectToRoom(TwilloVideoActivity.this.accessToken);
                } else {
                    Toast.makeText(TwilloVideoActivity.this,
